...
button {
  ...
  box-shadow:
    ...
    0 0.05em 0 0
      ...
      inset,
    0 -0.05em 0 0
      hsl(var(--hue) calc(var(--active) * 97%) calc(var(--active) * 10%)) inset;
  transition:
...
.star {
  ...
  -webkit-animation: orbit calc(var(--duration) * 1s) calc(var(--delay) * -1s)
    infinite linear;
...
.star--static {
  ...
  opacity: 0.9;
  -webkit-animation:
    move-x calc(var(--duration) * 0.1s) calc(var(--delay) * -0.1s) infinite
      linear,
